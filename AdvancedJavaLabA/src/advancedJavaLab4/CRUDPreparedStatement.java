...
class PreparedEg{
    ...
    public void createTable(){
        try {
            ...
            String tblQuery="create table tbl_labp ("
    ...
    public void fetchData(){
        try{
            ...
            String id=sc1.next();
            String disQuery1="select * from tbl_labp where id=?";
            //fetch data
//            String disQuery="select * from tbl_labp";
    ...
    public void updateData(){
        try{
            ...
            String upQuery="update tbl_labp set course=?,country=? where id='1'";
    ...
    public void delData(){
        try{
            ...
            String delQuery="delete from tbl_labp where id=?";
